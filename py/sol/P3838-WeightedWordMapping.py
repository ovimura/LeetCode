...
assert "onhpnpevpaaxkkab" == (s.mapWordWeights(
    ["ojibmbsqwf", "nmcksaj", "vinnwxscy", "mweijrtyin", "lqxxg", "d", "ykqyc", "cqlzt", "gimfdpp", "rnvaqe", "ajkaraz",
     "aoceuywyxq", "g", "g", "pmshdzobpw", "wb"],
